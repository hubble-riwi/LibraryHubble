                  ...
                  Seleccione una opción: ");
                    ...
                    switch (searchOption)
                    {
                        case "1":
                            ...
                            var bookByTitle = books.Find(b =>
                                b.title.Equals(searchTitle, StringComparison.OrdinalIgnoreCase));
                            if (bookByTitle != null)
                            {
                                Console.WriteLine(
                        ...
                        case "2":
                            ...
                            var booksByAuthor = books.Find(b =>
                        ...
                        case "3":
                            ...
                            var booksByCategory = books.Find(b =>
                                b.category.Equals(searchCategory, StringComparison.OrdinalIgnoreCase));
